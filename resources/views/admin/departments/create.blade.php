...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-plus-circle"></i> {{ __('إضافة قسم جديد') }}</h1>
            </div>
            ...
            <div class="col-md-12">
                <div class="tile">
                    <div class="d-flex mainAdd">
                        <h3 class="tile-title">{{ __('بيانات القسم') }}</h3>
                        <a href="{{ route('admin.departments.index') }}" class="btn btn-danger ml-auto">
